...
void AccType::on_btnCredit_clicked()
{
    ...
    QNetworkRequest request(QUrl("http://localhost/Group9/RestApi-master/index.php/api/client/idaccount/?idClient="+idClient+"&accType=CREDIT"));
...
void AccType::on_btnDebit_clicked()
{
    ...
    QNetworkRequest request(QUrl("http://localhost/Group9/RestApi-master/index.php/api/client/idaccount/?idClient="+idClient+"&accType=DEBIT"));
        request.setHeader(QNetworkRequest::ContentTypeHeader, "application/json");
        //Authenticate
        QString username="root";
        QString password="root";
